...
module.exports = {
  ...
  theme: {
    extend: {
      fontSize: {
        h1: ["48px", { lineHeight: "140%", fontWeight: 700 }],
        h2_bold: ["32px", { lineHeight: "140%", fontWeight: 700 }],
        h2_semibold: ["32px", { lineHeight: "140%", fontWeight: 600 }],
        h3_bold: ["24px", { lineHeight: "140%", fontWeight: 700 }],
        h3_medium: ["24px", { lineHeight: "140%", fontWeight: 500 }],
        h4_bold: ["18px", { lineHeight: "140%", fontWeight: 700 }],
        h4_semibold: ["18px", { lineHeight: "140%", fontWeight: 600 }],
        bodyL_medium: ["18px", { lineHeight: "140%", fontWeight: 500 }],
        bodyS_regular: ["16px", { lineHeight: "140%", fontWeight: 400 }],
        bodyS_medium: ["16px", { lineHeight: "140%", fontWeight: 500 }],
        bodyS_semibold: ["16px", { lineHeight: "140%", fontWeight: 600 }],
        bodyS_bold: ["16px", { lineHeight: "140%", fontWeight: 700 }],
        buttonL_semibold: ["16px", { lineHeight: "140%", fontWeight: 600 }],
        buttonS_semibold: ["14px", { lineHeight: "140%", fontWeight: 600 }],
        label_regular: ["14px", { lineHeight: "140%", fontWeight: 400 }],
        label_medium: ["14px", { lineHeight: "140%", fontWeight: 500 }], // FIXED
        label_semibold: ["14px", { lineHeight: "140%", fontWeight: 600 }],
        label_bold: ["14px", { lineHeight: "140%", fontWeight: 700 }],
        caption_regular: ["12px", { lineHeight: "140%", fontWeight: 400 }],
        caption_medium: ["12px", { lineHeight: "140%", fontWeight: 500 }], // FIXED
        caption_semibold: ["12px", { lineHeight: "140%", fontWeight: 600 }],
        caption_bold: ["12px", { lineHeight: "140%", fontWeight: 700 }],
      },
